...
class KWS:
    ...
    class_dict = {'aldfly': 0, 'balori': 1, 'banswa': 2, 'barswa': 3, 'bkbcuc': 4, 'bkcchi': 5,
                  'bkhgro': 6, 'blujay': 7, 'boboli': 8, 'brdowl': 9, 'brespa': 10, 'brncre': 11,
                  'buggna': 12, 'buhvir': 13, 'bushti': 14, 'canwar': 15, 'canwre': 16, 'carwre': 17,
                  'chispa': 18, 'comgra': 19, 'comrav': 20, 'comter': 21, 'daejun': 22, 'dowwoo': 23,
                  'eastow': 24, 'foxspa': 25, 'gnttow': 26, 'gryfly': 27, 'houfin': 28, 'mouchi': 29,
                  'norfli': 30, 'swaspa': 31, 'wesmea': 32, 'yebfly': 33, 'yerwar': 34}
...
def KWS_get_datasets(data, load_train=True, load_test=True, num_classes=6):
    ...
    if num_classes == 6:
        ...
        classes = ['aldfly', 'banswa', 'barswa', 'bkcchi', 'bkhgro', 'boboli', 'brdowl', 'brespa', 'buggna', 'buhvir', 'bushti', 'chispa', 'comgra', 'comrav', 'comter', 'daejun', 'gnttow', 'gryfly', 'houfin', 'swaspa']
    else:
